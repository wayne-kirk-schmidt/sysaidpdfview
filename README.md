...
```
PDF
1. inspect 	- produces - raw geometry, words, lines
2. examine   	- produces - layout-driven key/value records (authoritative)
3. display      - produces - human or JSON views over extracted structure
```
